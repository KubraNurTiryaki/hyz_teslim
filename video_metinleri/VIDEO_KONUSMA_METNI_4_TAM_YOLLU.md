# KONUŞMA METNİ #4 — TAM YOLLU (nihai)
...
Her görselin ve kod dosyasının **tam yolu yazılı** — çekim sırasında arama yok.
Termal kip metinden çıkarıldı. Jüri karşılıklı soru sormayacağı için soru-cevap
hazırlığı da yok; metin tek yönlü anlatım olarak kurgulandı.
...
| # | Zaman | Ne gösterilecek | TAM YOL |
|---|---|---|---|
| 1 | 0:00 | Kod — modül başlığı, **satır 1-18** | `/home/kurt/Masaüstü/test/havacilikta-yapay-zeka-yarismasi/TAKIM_BAGLANTI_ARAYUZU/src/object_detection_model.py` |
| 2 | 0:15 | Aynı dosya, **satır 32-43** (yollar + import) | *(yukarıdakinin aynısı)* |
| 3 | 0:30 | Kod — SLAM'in başlatılması, **satır 149-159** | `/home/kurt/Masaüstü/teknofest_gorev2/gorev2_engine.py` |
| 4 | 0:50 | Kod — `detect()`, **satır 181-297**, yavaş kaydır | `/home/kurt/Masaüstü/test/havacilikta-yapay-zeka-yarismasi/TAKIM_BAGLANTI_ARAYUZU/src/object_detection_model.py` |
| 5 | 1:25 | Kod — `kare_isle()`, **satır 146-190** | `/home/kurt/Masaüstü/teknofest_gorev2/gorev_1/yarisma_pipeline.py` |
| 6 | 1:45 | **Görsel (tam ekran)** — turuncu Görev 1 kutuları | `/home/kurt/Masaüstü/teknofest_gorev2/gorseller_2026/kare_000520.jpg` |
| 7 | 2:00 | Kod — `process_frame()`, **satır 297-340** | `/home/kurt/Masaüstü/teknofest_gorev2/gorev2_engine.py` |
| 8 | 2:15 | Kod — `_umeyama_2d()`, **satır 112-121** | `/home/kurt/Masaüstü/teknofest_gorev2/alignment.py` |
| 9 | 2:45 | **Görsel (tam ekran)** — BOZUK hizalama, 33.8 m | `/home/kurt/Masaüstü/teknofest_gorev2/analiz_3eksen/oturum4.png` |
| 10 | 2:55 | **Görsel (tam ekran)** — DÜZELTİLMİŞ, 6.2 m | `/home/kurt/Masaüstü/teknofest_gorev2/analiz_3eksen/oturum4_duzeltilmis.png` |
| 11 | 3:15 | Kod — FP koruması, **satır 275-295** | `/home/kurt/Masaüstü/test/havacilikta-yapay-zeka-yarismasi/TAKIM_BAGLANTI_ARAYUZU/src/object_detection_model.py` |
| 12 | 3:30 | **Görsel (tam ekran)** — yeşil G3 kutusu + referans küçük resmi | `/home/kurt/Masaüstü/teknofest_gorev2/gorseller_2026/kare_001955.jpg` |
| 13 | 3:50 | Kod — `--drop`, `--limit` argümanları | `/home/kurt/Masaüstü/teknofest_gorev2/resmi_mock.py` |
| 14 | 4:00 | **Görsel (tam ekran)** — yörünge + hata eğrisi | `/home/kurt/Masaüstü/teknofest_gorev2/gorseller_2026/yorunge_2026.png` |
| 15 | 4:15 | Kod — `detect()` tamamı, uzaklaştırılmış | `/home/kurt/Masaüstü/test/havacilikta-yapay-zeka-yarismasi/TAKIM_BAGLANTI_ARAYUZU/src/object_detection_model.py` |

**Yedek görseller** (metinde geçmiyor, elinin altında dursun):
- RGB 3 eksen (GT vs SLAM): `/home/kurt/Masaüstü/teknofest_gorev2/analiz_3eksen/2026_ornek_veri.png`
- Kutulu hareketli video (16 sn): `/home/kurt/Masaüstü/teknofest_gorev2/gorseller_2026/prova_500_620.mp4`

Klasörleri açmak için:
```bash
xdg-open ~/Masaüstü/teknofest_gorev2/gorseller_2026
xdg-open ~/Masaüstü/teknofest_gorev2/analiz_3eksen
```
...
**EKRAN #1:** `…/TAKIM_BAGLANTI_ARAYUZU/src/object_detection_model.py` **satır 1-18**
...
**EKRAN #3:** `/home/kurt/Masaüstü/teknofest_gorev2/gorev2_engine.py` **satır 149-159**
...
**EKRAN #4:** `…/src/object_detection_model.py` → `detect()` **satır 181-297**,
yavaş kaydır. Üç görev bloğunun başlıkları ve `try/except` satırları görünsün
...
**EKRAN #5:** `/home/kurt/Masaüstü/teknofest_gorev2/gorev_1/yarisma_pipeline.py`
→ `kare_isle()` **satır 146-190**, üç `_det()` çağrısını sırayla işaretle
**EKRAN #6 (tam ekran, ~1:45):**
`/home/kurt/Masaüstü/teknofest_gorev2/gorseller_2026/kare_000520.jpg`
...
**EKRAN #7:** `/home/kurt/Masaüstü/teknofest_gorev2/gorev2_engine.py`
→ `process_frame()` **satır 297-340** (sağlık 1 / sağlık 0 dallanması)
**EKRAN #8:** `/home/kurt/Masaüstü/teknofest_gorev2/alignment.py`
→ `_umeyama_2d()` **satır 112-121** (yansıma adayı bloğu)
**EKRAN #9 (tam ekran, ~2:45):** `/home/kurt/Masaüstü/teknofest_gorev2/analiz_3eksen/oturum4.png`
— başlıkta **"33.8 m"** görünsün, **3 saniye dur**
**EKRAN #10 (tam ekran, ~2:55):** `/home/kurt/Masaüstü/teknofest_gorev2/analiz_3eksen/oturum4_duzeltilmis.png`
— başlıkta **"6.2 m"**
...
**EKRAN #11:** `…/src/object_detection_model.py` **satır 275-295**,
`if not bbox: continue` satırını fareyle işaretle
**EKRAN #12 (tam ekran, ~3:30):**
`/home/kurt/Masaüstü/teknofest_gorev2/gorseller_2026/kare_001955.jpg`
...
**EKRAN #13:** `/home/kurt/Masaüstü/teknofest_gorev2/resmi_mock.py`
(`--drop`, `--limit` argümanları görünsün)
**EKRAN #14 (tam ekran, ~4:00):**
`/home/kurt/Masaüstü/teknofest_gorev2/gorseller_2026/yorunge_2026.png`
...
**EKRAN #15:** `…/src/object_detection_model.py` → `detect()` tamamı, uzaklaştırılmış
...
- `/home/kurt/Masaüstü/test/havacilikta-yapay-zeka-yarismasi/TAKIM_BAGLANTI_ARAYUZU/config/.env`
  — takım adı, **şifre**, sunucu adresi
...
Bu tablo jüri için değil, **kendi doğrulamanız için**: videoda bir sayı
söylemeden önce kaynağına bakın, tutarsız rakam söylemeyin.

| Rakam | Kaynak |
|---|---|
| mAP@0.5 = 0.849 | `SETUP_LOG.md` satır 599-601 |
| 33,8 m → 6,2 m (z: 27,7 → 3,2) | `analiz_3eksen/oturum4*.png` grafik başlıkları |
| 2025 Denklem-2: 4,3 – 8,8 m | `SETUP_LOG.md` satır 572-578 (v8 tablosu) |
...
tablosunda. Bu dosyayı ya güncelleyin ya da başına "v1 baz ölçümü, nihai sonuçlar
için SETUP_LOG v8 tablosu" notu ekleyin. `rapor_o2/*.png` grafikleri de v1
verisinden üretilmiş — **videoda onları göstermeyin.**
